...
//********************************************************************
	...
	private static void testInsert(ImpiegatoDAO impiegatoDAOInstance, CompagniaDAO compagniaDAOInstance)
		...
		// eseguo la insert
		Date dataDiNascitaPerTestInsert = new SimpleDateFormat("dd-MM-yyyy").parse("06-01-1995");
		Date dataAssunzionePerTestInsert = new SimpleDateFormat("dd-MM-yyyy").parse("13-05-2021");
		Compagnia compagniaPerLaQualeLavoraImpiegato = compagniaDAOInstance.list().get(0);

		Impiegato impiegatoDaInserire = new Impiegato("Mattia", "La Rocca", "lrcmtg95a06a494x", dataDiNascitaPerTestInsert,
