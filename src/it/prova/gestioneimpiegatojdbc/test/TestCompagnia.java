...
//*************************************************************			
	...
	private static void testInsert(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		// eseguo la insert
		Date dataPerTestInsert = new SimpleDateFormat("dd-MM-yyyy").parse("15-02-2012");
		Compagnia compagniaDaInserire = new Compagnia("Sotec servizi", 200000, dataPerTestInsert);
